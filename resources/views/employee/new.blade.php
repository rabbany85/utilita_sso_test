  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form method="POST" class="form-horizontal" action="{{route('employee.new')}}">
                @csrf
              <div class="form-group">
                <label for="inputName">First Name</label>
                <input type="text" id="inputName" class="form-control" name="first_name">
              </div>
              <div class="form-group">
                <label for="inputName">Last Name</label>
                <input type="text" id="inputName" class="form-control" name="last_name">
              </div>
              <div class="form-group">
